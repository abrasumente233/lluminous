...
{#if open}
	...
	<div
		...
		class="{className} fixed left-1/2 top-1/2 z-[101] max-h-[80vh] w-[95%] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border bg-white px-5 py-6 shadow-2xl scrollbar-ultraslim md:w-[700px]"
	>
		<button
			on:click={() => {
				open = false;
